...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      '您可以隨時在「個人主頁 → 編輯個人資料 → 刪除帳號」自行刪除帳號：個人檔案、上架商品、私訊、訂單、評價、通知與您上傳的照片會一併刪除，且無法復原。若仍有進行中的交易，系統會請您先完成或取消。',
  ...
  },
  {
    title: '八、您的權利',
    paragraphs: [
      '依個人資料保護法，您可以查詢、閱覽、請求補充或更正、請求停止蒐集處理利用，以及請求刪除您的個人資料。暱稱、頭像、簡介與身分可在「編輯個人資料」自行修改，整個帳號也可以在同一頁自行刪除；其他請求請透過「聯絡我們」提出，我們會在確認身分後處理。',
    ],
  },
  {
    title: '九、資料安全與本機儲存',
