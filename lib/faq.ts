...
export const FAQ_ENTRIES: FaqEntry[] = [
  ...
  },
  {
    ...
    answer: [
      '易拍通有防砍價門檻：全新未拆的商品至少要出到售價的 90%，其他成色至少 80%。',
  ...
  },
  {
    ...
    answer: [
      '不會。易拍通不代開物流單，出貨與取號請賣家自行到超商或物流商辦理。',
  ...
  },
  {
    ...
    question: '平台會代收款項嗎？',
    answer: [
      '不會。易拍通不代收金流，款項由買賣雙方直接往來，平台不經手也不儲存任何卡號、銀行帳號密碼或支付憑證。',
  ...
  },
  {
    ...
    answer: [
      '打開右上角鈴鐺進入通知中心，最上面有「推播通知」開關。第一次開啟時系統會問你要不要允許易拍通傳送通知，允許後就完成註冊。',
      '所有站內通知都會推播：新私訊、有人出價或成立訂單、交易完成或取消、商品審核結果、檢舉處理結果、收到新評價、每日 EcoCoins 入帳，以及客服回覆你的來信。',
      '若你之前按了「不允許」，開關會顯示被系統封鎖，要先到裝置的「設定 → 通知」允許易拍通再回來開啟。關閉推播不影響通知中心，訊息一樣會留在裡面。',
  ...
  },
  {
    ...
    answer: [
      '在「個人主頁 → 編輯個人資料」最下方有「刪除帳號」：輸入「刪除帳號」四個字確認後，個人檔案、上架商品、私訊、評價、通知與上傳的照片會立即移除，無法復原。',
      '若還有進行中的交易，系統會請你先完成或取消，避免交易對象的紀錄突然消失。',
